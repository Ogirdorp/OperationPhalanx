...
import loads.ana_crates as ana
...
crates = [
	...
	ana_medical(prefix='sh_alive_').generate_config(),
]


for grp in ['ana_crates', 'marine_crates', 'abe_crates', 'acr_crates', 'ukbaf_crates', 'soar_crates']:
